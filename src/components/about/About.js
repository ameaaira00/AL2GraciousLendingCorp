    ...
    return (
        <section id="about" className="section">
            <div className="content">
                <h2>About Gracious Group Lending Philippines Corporation</h2>
                <p>
                    Gracious Sales Gracious Group Lending Phils., Corp., is registered with the Securities and Exchange Commission with SEC Reg No CS200711606 and CA No 172.
